...
.swiper-component ul li {
  list-style: none;
  height: 100%;
  float: left;
  overflow: hidden;
}
.swiper-component ul li img {
  width: 100%;
  height: 100%;
}
.swiper-component ul li.zoom {
  border-radius: 0.16rem;
  transform: scale(0.93);
  transition: 0.5s ease;
}
.swiper-component ul li.zoom.active {
  transform: scale(1);
}
.swiper-component .swiper-dots {
  position: absolute;
  bottom: 0.16rem;
  left: 50%;
...
.swiper-component .swiper-dots .dots-item {
  width: 0.1rem;
  height: 0.1rem;
  border-radius: 50%;
...
.swiper-component .swiper-dots .dots-item.active {
  background: #409eff;
}
</style>